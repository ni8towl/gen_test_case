...
def get_user_logic():
    ...
    user_input = simpledialog.askstring(
        ...
        f"You can use logic operators 'and', 'or' and 'not'\n\n"
...
def select_xlsx_file():
    # Create a Tk root widget (main window)
    root = tk.Tk()
    root.withdraw()  # Hide the root window

    # Show the file dialog to select an .xlsx file
    ...
    # Destroy the Tk root widget after use
    root.destroy()
