...
# def choose_test_type():
#     """
#     Opens a pop-up GUI for the user to select between two test types.
#     Blocks further execution until the user confirms their selection.
#
#     Returns:
#         int: The value corresponding to the selected test type.
...
#     test_type = simpledialog.askinteger(
#         "Choose Test Type",
#         "Select the test type:\n"
#         "Choose one of these numbers:\n\n"
#         "1 -> SPC (True/False)\n\n"
#         "2 -> DPC (OPEN/CLOSED). For testing switchgear.\n"
#         "(Intermediate and Bad are not included)\n",
#         parent=root,
#         minvalue=1,
#         maxvalue=2,
#     )
#
#     # Destroy the main window after selection
#     root.destroy()
#
#     # Validation
#     if test_type in [1, 2]:
